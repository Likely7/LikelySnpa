...
6. Revisit cursor-follow zoom only if a new reproducible screen/window recording shows measurable offset after checkpoint `2ecbca8`.
...
6. Confirm auto-generated zooms and manual Auto-Focus zooms follow cursor as a regression check.
